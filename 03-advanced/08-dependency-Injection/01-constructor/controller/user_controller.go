...
type UserController struct {
	userService service.UserService // 🔌 Dependency ที่ได้รับจาก Constructor
}

// NewUserController creates a new user controller
// 🔌 Constructor Injection: รับ UserService มาจากภายนอก
func NewUserController(userService service.UserService) *UserController {
	return &UserController{
		userService: userService, // Inject dependency ตอนสร้าง
	}
}
