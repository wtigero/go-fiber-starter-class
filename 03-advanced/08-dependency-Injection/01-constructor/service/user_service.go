...
type userService struct {
	repo repository.UserRepository // 🔌 Dependency ที่ได้รับจาก Constructor
}

// NewUserService creates a new user service
// 🔌 Constructor Injection: รับ UserRepository มาจากภายนอก
func NewUserService(repo repository.UserRepository) UserService {
	return &userService{
		repo: repo, // Inject dependency ตอนสร้าง
	}
}
